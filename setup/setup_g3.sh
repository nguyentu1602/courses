#!/bin/bash
#
# Configure a g3.4xlarge instance
...
if [ $region = "us-west-2" ]; then
   ...
   export ami="ami-28aa8751" # "ami-c6feddbf" # my own in Ireland # export ami="ami-75fbdd0c" # Ireland - my own AMI - 1st
...
export instanceType="g3.4xlarge"
